...
const ExperienceCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 md:mt-0 text-primary/50 font-mono text-sm">{period}</div>
    </motion.div>
  );
};
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mt-20">
          <div className="lg:col-span-8">
            <h2 className="text-sm font-semibold tracking-[0.3em] uppercase text-accent mb-8">
              The Studio
            </h2>
            <p
              ref={textRef}
              className="text-3xl md:text-5xl font-light leading-snug md:leading-tight text-primary/20"
            >
              We blend architectural precision with artistic vision to create physical spaces that
              don&apos;t just exist—they inspire, comfort, and endure. We design for the way you
              live.
            </p>
