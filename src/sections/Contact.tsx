...
export const Contact = () => {
  ...
  const inputClasses = "w-full bg-transparent border-b border-primary/20 pb-4 text-primary placeholder:text-primary/30 focus:outline-none focus:border-primary transition-colors duration-300 resize-none";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="flex flex-col space-y-6">
              <a href="mailto:hello@example.com" className="text-2xl hover:text-accent transition-colors flex items-center gap-4 group hover-target w-max text-primary">
                hello@example.com
              ...
              <div className="flex gap-6 pt-8">
                <a href="#" className="p-4 rounded-full border border-primary/10 hover:bg-primary hover:text-background transition-colors hover-target text-primary" aria-label="Instagram"><Instagram size={20} /></a>
                <a href="#" className="p-4 rounded-full border border-primary/10 hover:bg-primary hover:text-background transition-colors hover-target text-primary" aria-label="Facebook"><Facebook size={20} /></a>
                <a href="#" className="p-4 rounded-full border border-primary/10 hover:bg-primary hover:text-background transition-colors hover-target text-primary" aria-label="LinkedIn"><Linkedin size={20} /></a>
              </div>
            </div>
          </div>
          ...
          >
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-12">
              ...
              {status === 'success' && (
                <p className="text-green-400 text-sm text-center">Thank you! I will get back to you soon.</p>
              )}
              {status === 'error' && (
